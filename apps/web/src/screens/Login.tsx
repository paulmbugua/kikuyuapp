// src/pages/Login.tsx (Updated with Auth Context)
...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.log('Got Google result:', result.user.email);
      
      toast.loading('Authenticating...', { id: 'auth-loading' });
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="thutha-card p-6 space-y-4 animate-fade-up backdrop-blur-sm bg-card/80" style={{ animationDelay: '0.3s' }}>
          <h2 className="text-lg font-heading font-semibold text-center text-foreground">
            Welcome back
          </h2>
